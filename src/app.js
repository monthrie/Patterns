...
function KnotMakerMobile() {
  ...
  const [cycleStripOpen, setCycleStripOpen] = useState(false);
  ...
  const cycleBalance = useMemo(() => {
    ...
    const summary = fair ? `Roughly balanced (each cycle ~${(100 / cycles.length).toFixed(0)}% of length).` : `Uneven: shortest cycle ${minP.toFixed(0)}% of total length, longest ${maxP.toFixed(0)}%.`;
  ...
  }, cycleBalance && /*#__PURE__*/React.createElement("span", {
    style: {
      width: 10,
      height: 10,
      borderRadius: "50%",
  ...
  }, cycles.length === 1 ? "cycle" : "cycles"), selGap !== null && active && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--hair)"
    }
  }, "|"), /*#__PURE__*/React.createElement("span", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Colours (", cycles.length, ")"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14
    }
  ...
  }, "Tap a swatch to change colour"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 6
  ...
  const tabPanelsEl = /*#__PURE__*/React.createElement(React.Fragment, null, activeTab === 'edit' && /*#__PURE__*/React.createElement("div", {
  ...
  }, "O n\xFAmero no topo mostra quantos ", /*#__PURE__*/React.createElement("strong", null, "ciclos"), " o padr\xE3o tem. O ponto colorido indica o ", /*#__PURE__*/React.createElement("strong", null, "equil\xEDbrio"), ": verde = ciclos semelhantes, laranja = alguns dominantes, vermelho = um ciclo muito maior."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 6px"
    }
  }, "Para come\xE7ar com um ret\xE2ngulo, coloque as dimens\xF5es (pregos \xD7 pregos) no bot\xE3o ", /*#__PURE__*/React.createElement("strong", null, "\"Grid size\""), ", e depois carregue em ", /*#__PURE__*/React.createElement("strong", null, "\"Fill\""), " para preencher."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 6px"
    }
  }, /*#__PURE__*/React.createElement("strong", null, "Arraste o dedo"), " na grelha para adicionar ou remover c\xE9lulas \u2014 os ciclos atualizam em tempo real."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 6px"
    }
  }, "Se gostar de uma forma, carregue em ", /*#__PURE__*/React.createElement("strong", null, "\"Shapes\" \u2192 \"Save\""), " para guardar."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 6px"
    }
  }, "Em baixo pode ver o padr\xE3o. Para ver em detalhe, v\xE1 a ", /*#__PURE__*/React.createElement("strong", null, "\"Mode\""), " e escolha ", /*#__PURE__*/React.createElement("strong", null, "thick"), ", ", /*#__PURE__*/React.createElement("strong", null, "thin"), " ou ", /*#__PURE__*/React.createElement("strong", null, "string"), " para ver como o padr\xE3o fica."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      opacity: 0.7
    }
    ...
    id: "grid-size-toggle"
  }, /*#__PURE__*/React.createElement("span", null, "Grid size", " ", /*#__PURE__*/React.createElement("span", {
  ...
  }, gridSizePanelOpen ? "hide" : "change"), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": true,
    style: {
      fontSize: 10,
      color: "var(--accent-soft)"
  ...
  }, cycleStripEl, colourPickerEl, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      alignItems: "center",
  ...
  }, name))), savedShapes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap",
    ...
    onClick: e => {
      e.stopPropagation();
      if (window.confirm(`Delete "${s.name}"?`)) deleteShape(s.name);
    }
  ...
  }, "Strand"), ['thin', 'full', 'string'].map(mode => /*#__PURE__*/React.createElement("button", {
    key: mode,
  ...
  }, "Nails")), stringStats.totalLen > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      borderTop: "1px solid var(--hair)",
      paddingTop: 12
  ...
  }, "String lengths \u2014 total: ", (stringStats.totalLen * 15 / 10).toFixed(0), "cm"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 6
  ...
  }, "Shapes"), /*#__PURE__*/React.createElement("button", {
