...
He has made an entire **jacket** this way. It contains exactly **eight loops** — eight circles of cotton cord, and nothing else. No thread in it has an end: when each cord completes its journey and returns home, he joins it back to its own beginning with a splice so fine that you cannot find it. Search the jacket as long as you like — there is no start and no finish anywhere in it. It took him nearly two hundred hours, following a process he invented himself. If you could pull one strand free and shake it out, you would not be holding a pile of threads; you would be holding one enormous, unbroken circle — one eighth of a jacket. The garment remembers what it is made of.
